        ...
        >
          ...
          <CContainer>
            ...
            >
              <CCol md="6">
                ...
                <CLabel className={"reAssign-Detail22"}>
                  {selected.assignedTo
          ...
          <CRow style={{ marginTop: "25px" }}>
            <CCol>
              <Tabs>
                <TabList>
                  <Tab onClick={partyShow}>Party Posting</Tab>
                  <Tab onClick={chiefministerShow}>As a MP</Tab>
                  <Tab onClick={deputychiefministerShow}>As a MLA</Tab>
                  <Tab onClick={ministryShow}>State Minister</Tab>
                  <Tab onClick={centralMinister}>Central Minister</Tab>
                </TabList>
              </Tabs>
            </CCol>
          </CRow>
