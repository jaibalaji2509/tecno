...
const PartyPosting = () => {
  ...
  const handleClickdepartment = () => {
    switch (menu.menuStatus) {
      ...
      default:
        ...
        setSideBaradddepe(false);
        setSideBaradddese(false);
        setSideBaraddrolee(false);
  ...
  const [sideBaradddepe, setSideBaradddepe] = useState(false);
  const [sideBaradddese, setSideBaradddese] = useState(false);
  const [sideBaraddrolee, setSideBaraddrolee] = useState(false);
                ...
                <CCol md="12" lg="12" sm="12">
                  <div>
                    ...
                    >
                      ...
                      <CCol md="6" style={{marginLeft:"-130px"}}> 
                        <CLabel
                          className={"form-labels-9 col-md-5 reAssign-Label"}
                        >
                          Designation:{" "}
                      ...
                      <CCard className={"cardSave"}>
                        ...
                        {locationHide.corporation && (
                          <div>
                                  ...
                                  <React.Fragment>
                                    ...
                                    >
                                      ...
                                      <Select
                                        ...
                                        components={{
                                          MenuList: SelectMenuButtondepartment,
                                        }}
                                  ...
                                  <React.Fragment>
                                    ...
                                    >
                                      ...
                                      <Select
                                        ...
                                        components={{
                                          MenuList: SelectMenuButtondesignation,
                                        }}
                            ...
                            <CRow
                              style={{ marginTop: "95px", marginLeft: "350px" }}
                            >
                              <CCol md="10">
                                <CCol
                                  md="5"
                              ...
                              <CCol md="10">
                                ...
                                >
                                  <CButton
                                    ...
                                    id={
                                      "AdministrationsaveAbbreviationConfigureCode"
                                    }
                                    className={"saveBtn"}
                                    onClick={saveCorporation}
                                  >
