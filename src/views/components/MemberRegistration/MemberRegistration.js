        ...
        {memberhide && (
          <div>
            <div className={"main-headerlabel"}>
              <span className={"header-label"} style={{ fontSize: "30px" }}>
                Member Registration
              </span>
            </div>
            <CRow style={{ marginTop: "30px" }}>
              <CCol sm="6" lg="3" style={{ marginLeft: "10px" }}>
                <CWidgetDropdown
                  ...
                  text=""
                >
                  <span style={{ marginLeft: "30px", fontSize: "30px" }}>
                    Male
                  </span>
                  <span style={{ marginLeft: "-89px", marginTop: "30px" }}>
                    2
                  </span>
                  <br />
                  <br />
              ...
              <CCol sm="6" lg="3" style={{ marginLeft: "10px" }}>
                ...
                >
                  ...
                  <span style={{ marginLeft: "-100px", marginTop: "30px" }}>
                    2
                  </span>
                  <br />
                  <br />
                  <CImg
                    style={{ width: "20px", height: "20px" }}
                    src="https://icons.iconarchive.com/icons/custom-icon-design/flatastic-7/512/Female-icon.png"
                  />
                </CWidgetDropdown>
              </CCol>
              ...
              <CCol sm="6" lg="3" style={{ marginLeft: "-10px" }}>
                <CWidgetDropdown
                  ...
                  text=""
                >
                  <span style={{ marginLeft: "-18px", fontSize: "30px" }}>
                    TransGender
                  </span>
                  <span style={{ marginLeft: "-126px", marginTop: "30px" }}>
                    1
                  </span>
                  <br />
                  <br />
                  <CImg
                    style={{ width: "20px", height: "20px" }}
                    src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/11/A_TransGender-Symbol_Plain3.svg/878px-A_TransGender-Symbol_Plain3.svg.png"
                  />
                </CWidgetDropdown>
              </CCol>
              ...
              <CCol sm="6" lg="3" style={{ marginLeft: "-10px" }}>
                ...
                >
                  ...
                  <span style={{ marginLeft: "-140px", marginTop: "30px" }}>
                    5
                  </span>
                  <br />
                  <br />
                  <CImg
                    style={{ width: "20px", height: "20px" }}
                    src="https://p.kindpng.com/picc/s/265-2652987_persons-png-transparent-png.png"
                  />
                </CWidgetDropdown>
              </CCol>
            </CRow>
