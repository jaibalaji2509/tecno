...
const TownPanchayat = () => {
  ...
  const stateselect = [{ value: "tamil", label: "Tamilnadu" }];
  const cityselect = [{ value: "Kancheepuram", label: "Chengalpattu" }];
  const townselect = [
    {
      span: (
