          ...
          {head && (
            <thead>
              <tr onClick={kill} style={{ cursor: "pointer" }}>
                ...
                <th>State</th>
                <th>District</th>
                <th>Name of the TownPanchayat</th>
                <th>Area Name</th>
                <th>Ward Number</th>
          ...
          <tbody>
            {onFirst && (
              <tr style={{ cursor: "pointer" }}>
                ...
                <td onClick={hanldeChange}>Kancheepuram</td>
                <td onClick={hanldeChange}>Kundrathur</td>
                <td onClick={hanldeChange}>Kovur</td>
                <td onClick={hanldeChange}>0018</td>
            ...
            {onsecond && (  
              <tr style={{ cursor: "pointer" }}>
                ...
                <td onClick={hanldeChange1}>Kancheepuram</td>
                <td onClick={hanldeChange1}>Kundrathur</td>
                <td onClick={hanldeChange1}>Kovur</td>
                <td onClick={hanldeChange1}>0018</td>
            ...
            {secon && (
              <tr style={{ cursor: "pointer" }}>
                ...
                <td onClick={hilk}>Chengalpattu</td>
                <td onClick={hilk}>Acharapakkam</td>
                <td onClick={hilk}>Alapakkam</td>
                <td onClick={hilk}>198</td>
            ...
            {secon1 && (
              <tr style={{ cursor: "pointer" }}>
                ...
                <td onClick={hilk1}>Chengalpattu</td>
                <td onClick={hilk1}>Acharapakkam</td>
                <td onClick={hilk1}>Alapakkam</td>
                <td onClick={hilk1}>198</td>
            ...
            {third && (
              <tr style={{ cursor: "pointer" }}>
                ...
                <td onClick={hulk}>Thiruvallur</td>
                <td onClick={hulk}>Ponneri</td>
                <td onClick={hulk}>Sholavaram</td>
                <td onClick={hulk}>006</td>
            ...
            {third1 && (
              <tr style={{ cursor: "pointer" }}>
                ...
                <td onClick={hulk1}>Thiruvallur</td>
                <td onClick={hulk1}>Ponneri</td>
                <td onClick={hulk1}>Sholavaram</td>
                <td onClick={hulk1}>006</td>
