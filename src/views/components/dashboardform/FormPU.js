                ...
                {head && (
                  <thead>
                    <tr onClick={kill} style={{ cursor: "pointer" }}>
                      ...
                      <th>State</th>                     
                      <th>District</th>
                      <th>Town Panchayat Ward Number</th>              
                ...
                <tbody>
                  {onFirst && (
                    <tr style={{ cursor: "pointer" }}>
                      ...
                      <td onClick={hanldeChange}>Ariyalur Ward no.7</td>              
                  ...
                  {onsecond && (
                    <tr style={{ cursor: "pointer" }}>
                      ...
                      <td onClick={hanldeChange1}>Ariyalur Ward no.7</td>              
                  ...
                  {state.hide1 && (
                    ...
                    <tr style={{ cursor: "pointer" }}>
                      ...
                      <td onClick={hilk}>Alanganallur Ward no.14</td>              
                  ...
                  {secon1 && (
                    <tr style={{ cursor: "pointer" }}>
                      ...
                      <td onClick={hilk1}>Alanganallur Ward no.14</td>              
                  ...
                  {third && (
                    <tr style={{ cursor: "pointer" }}>
                      ...
                      <td onClick={hulk}>Udankudi Ward No 10</td>            
                  ...
                  {third1 && (
                    <tr style={{ cursor: "pointer" }}>
                      ...
                      <td onClick={hulk1}>Udankudi Ward No 10</td>             
