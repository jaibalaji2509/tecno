        ...
        <tbody>
          {onFirst && (
            <tr style={{ cursor: "pointer" }} onClick={hanldeChange}>
              ...
              <td onClick={hanldeChange}>Udhayanidhi Stalin</td>
            </tr>
          )}
          {onsecond && (
            <tr style={{ cursor: "pointer" }} onClick={hanldeChange1}>
              ...
              <td onClick={hanldeChange1}>Udhayanidhi Stalin</td>
            </tr>
          )}
          {state.hide1 && (
            <tr className={"long1"}>
              ...
              <td>
                <h3 className={"headname"}>Udhayanidhi Stalin</h3>
          ...
          {secondata && (
            <tr className={"long1"}>
              ...
              <td>
                {" "}
                <h3 className={"headname"}>R T Sekar</h3>
                <p className={"paraname"}> Gender: Male</p>
                <p className={"paraname"}> Katchup id:</p>
                <p className={"paraname"}>Address:</p>
                <p className={"paraname"}>Phone:(+91)xxx xx xx xxx</p>
          ...
          {third1 && (
            <tr style={{ cursor: "pointer" }} onClick={hulk1}>
              ...
              <td onClick={hulk1}>P Thayagam</td>
            </tr>
          )}
          {thirdata && (
            <tr className={"long1"}>
              ...
              <td>
                <h3 className={"headname"}>P Thayagam</h3>
