        ...
        {head && (
          <thead>
            <tr onClick={kill} style={{ cursor: "pointer" }}>
              ...
              <th>Sno.</th>
              <th>Name of the District Party Office</th>
              <th>Department</th>
              <th>Designation</th>
              <th>Role</th>
        ...
        <tbody>
          {onFirst && (
            <tr style={{ cursor: "pointer" }} onClick={hanldeChange}>
              ...
              <th>1.</th>
              <td>Dindigul District</td>
              <td >Administration</td>
              <td onClick={hanldeChange}>Party Secretary</td>
              <td onClick={hanldeChange}>-</td>
          ...
          {onsecond && (
            <tr style={{ cursor: "pointer" }} onClick={hanldeChange1}>
              ...
              <th>1.</th>
              <td>Dindigul District Branch Office</td>
              <td onClick={hanldeChange1}>Administration</td>
              <td onClick={hanldeChange1}>Party Secretary</td>
              <td onClick={hanldeChange1}>-</td>
          ...
          {secon && (
            <tr style={{ cursor: "pointer" }} onClick={hilk}>
              <td onClick={hilk}>+</td>
              <th>2.</th>
              <td>Trichy District Office</td>
              <td onClick={hilk}>Marketing </td>
              <td onClick={hilk}>District Secretary</td>
              <td onClick={hilk}>-</td>
          ...
          {secon1 && (
            <tr style={{ cursor: "pointer" }} onClick={hilk1}>
              <td onClick={hilk1}>-</td>
              <th>2.</th>
              <td>Trichy District Branch Office</td>
              <td onClick={hilk1}>Marketing </td>
              <td onClick={hilk1}>District Secretary</td>
              <td onClick={hilk1}>-</td>
          ...
          {third && (
            <tr style={{ cursor: "pointer" }} onClick={hulk}>
              <td onClick={hulk}>+</td>
              <th>3.</th>
              <td>Tiruvannamalai District Office</td>
              <td onClick={hulk}>Accounting and Finance</td>
              <td onClick={hulk}>General Secretary</td>
              <td onClick={hulk}>-</td>
          ...
          {third1 && (
            <tr style={{ cursor: "pointer" }} onClick={hulk1}>
              <td onClick={hulk1}>-</td>
              <th>3.</th>
              <td>Tiruvannamalai District Branch Office</td>
              <td onClick={hulk1}>Accounting and Finance</td>
              <td onClick={hulk1}>General Secretary</td>
              <td onClick={hulk1}>-</td>
