        ...
        <CCard className={"cardSave"}>
          ...
          <CRow className={"row-alignment"} style={{marginLeft:"-76px"}}>
            ...
            <CCol  className={"column-align"} md="12" lg="12" sm="12">
                  ...
                  <React.Fragment>
                    <CCol  className={"column-align"} md={5} lg={5}>
                      ...
                      <Select
                        ...
                        value={cityName}
                        options={citySchema}
                        isDisabled={CountryCreate || StateCreate || AreaCreate}
                      />
               </CCol>
                  ...
                  <React.Fragment>
                    <CCol  className={"column-align"} md={5} lg={5}>
                      ...
                      <Select
                        ...
                        options={areaSchema}
                        isDisabled={CountryCreate || StateCreate || CityCreate}
                      />
               </CCol>
              ...
              <CRow style={{ padding: "1%", marginTop: "1.5%",marginLeft:"27px" }}>
                <CDataTable
                  items={areasSchema}
                  fields={fields}
                  columnFilter
                  ...
                  scopedSlots={{
                    show_details: (item, index) => {
                      return (
                        <td className="py-2">
                          <CRow>
                            <CCol  className={"column-align"} style={{ fontSize: "1.15rem" }} md="12">
                              <i
                                onClick={() => {
                                  toggleDetails(index);
                                }}
