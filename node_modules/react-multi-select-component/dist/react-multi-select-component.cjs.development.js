...
var SearchClearButton = /*#__PURE__*/goober.css({
  cursor: "pointer",
  position: "absolute",
  top: 0,
  right: 0,
...
var SelectPanel = function SelectPanel(props) {
  ...
  var _useState3 = React.useState(focusSearchOnOpen && !disableSearch ? FocusType.SEARCH : FocusType.NONE),
...
var ClearSelectedButton = /*#__PURE__*/goober.css({
  cursor: "pointer",
  background: "none",
  border: 0,
  padding: 0,
...
var Dropdown = function Dropdown(_ref) {
  ...
  }, children), isLoading && React__default.createElement(Loading, null), contentProps["value"].length > 0 && React__default.createElement("button", {
    type: "button",
