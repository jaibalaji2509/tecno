...
export declare type UseFormMethods<TFieldValues extends FieldValues = FieldValues> = {
    ...
    setValue(name: FieldName<TFieldValues>, value: FieldValue<TFieldValues> | UnpackNestedValue<DeepPartial<TFieldValues>> | string[] | undefined | null | boolean, options?: SetValueConfig): void;
