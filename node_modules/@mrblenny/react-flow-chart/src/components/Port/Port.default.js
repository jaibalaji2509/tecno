...
exports.PortDefault = function (_a) {
    var isLinkSelected = _a.isLinkSelected, isLinkHovered = _a.isLinkHovered, config = _a.config, className = _a.className;
    return (React.createElement(PortDefaultOuter, { className: className },
        React.createElement(PortDefaultInner, { active: !config.readonly && (isLinkSelected || isLinkHovered) })));
};
